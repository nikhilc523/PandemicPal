...
router.post('/', async (req, res, next) => {
    ...
    if (query.toLowerCase() === "start" || query.toLowerCase() === "hi" || query.toLowerCase() === "help") {
        twiml.message(stripIndent`
            Hii! Amigo 👋
            I am your Personal Bot 🤖 built with ❤️ by *Nikhil Chowdary*. Here is what I can do for you:
            ...
            *get joke*
            ...
            Curious to see the code? Here is the Link for the code https://github.com/nikhilc523
